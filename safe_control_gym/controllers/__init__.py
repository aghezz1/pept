...
register(idx='mpc_acados_m',
         entry_point='safe_control_gym.controllers.mpc.mpc_acados_m:MPCAcadosMultiPhase',
         config_entry_point='safe_control_gym.controllers.mpc:mpc_acados_m.yaml')
